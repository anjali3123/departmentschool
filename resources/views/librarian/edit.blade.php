          ...
          <div class="container-fluid">
              ...
              <div class="row page-titles">
                  <div class="col-md-5 align-self-center">
                      <h4 class="text-themecolor">Edit Librarian</h4>
                  </div>
                  ...
                  <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          ...
                          <div class="card-body">
                              <form class="form-control-line" action="{{route('librarian.edit')}}" method="post">
                                @csrf
                                  ...
                                  {{-- <div class="col-md-4">
                                    <div class="form-group {{$errors->has('password')?'has-danger':''}}">
                                      ...
                                      @if ($errors->has('password'))
                                        <div class="form-control-feedback">{{ $errors->first('password',$user->password) }}</div>
                                      @endif
                                  </div> 
                                  </div> --}}
                                    <div class="col-md-4">
                                      <div class="form-group {{$errors->has('phoneno')?'has-danger':''}}">
                                        ...
                                        <input type="text" name="phoneno" value="{{old('phoneno',$user->phoneno)}}" class="form-control digit-only" placeholder="Phone No">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group {{$errors->has('departmentid')?'has-danger':''}}">
                                          ...
                                          <select name="departmentid" class="form-control adi-select2">
                                            ...
                                            <option value="{{$key->id}}" {{(old('departmentid',$user->departmentid) == $key->id)?'selected':''}}>{{$key->name}}</option>
                                            @endforeach
                                          </select>
